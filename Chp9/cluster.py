...
from  python.git_book_master.chapters.Cluster_EM.agglomerative_clustering import test_AgglomerativeClustering,test_AgglomerativeClustering_nclusters,test_AgglomerativeClustering_linkage
from python.git_book_master.chapters.Cluster_EM.dbscan import test_DBSCAN,test_DBSCAN_epsilon,test_DBSCAN_min_samples
from python.git_book_master.chapters.Cluster_EM.gmm import test_GMM,test_GMM_cov_type,test_GMM_n_components
from python.git_book_master.chapters.Cluster_EM.kmeans import test_Kmeans,test_Kmeans_n_init,test_Kmeans_nclusters
...
if __name__=='__main__':
    ...
    # centers=[[1,1],[4,3],[1,5],[10,20]] # 用于产生聚类的中心点
