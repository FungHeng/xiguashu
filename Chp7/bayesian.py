...
from python.git_book_master.chapters.Bayesian.gaussianNB import test_GaussianNB
from python.git_book_master.chapters.Bayesian.multinomialNB import test_MultinomialNB,test_MultinomialNB_alpha
from python.git_book_master.chapters.Bayesian.bernoulliNB import test_BernoulliNB,test_BernoulliNB_alpha,test_BernoulliNB_binarize
def load_data():
    '''
