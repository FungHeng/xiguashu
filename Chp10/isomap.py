...
def plot_Isomap_k_d3(*data):
    ...
    for i, k in enumerate(Ks):
        isomap=manifold.Isomap(n_components=3,n_neighbors=k)
        X_r=isomap.fit_transform(X)#原始数据集转换到三维
...
if __name__=='__main__':
    ...
    plot_Isomap_k_d3(X,y)
    plot_Isomap_k_d2(X,y)   # 调用 plot_Isomap_k
